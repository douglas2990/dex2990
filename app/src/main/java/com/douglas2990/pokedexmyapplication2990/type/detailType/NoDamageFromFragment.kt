...
import com.douglas2990.pokedexmyapplication2990.adapter.NoDamageFromAdapter
import com.douglas2990.pokedexmyapplication2990.databinding.FragmentTypeBinding

class NoDamageFromFragment: Fragment() {
    ...
    private val typeListenner = object : NoDamageFromAdapter.NoDamageFromInterface{
        override fun onClick(typeId: String) {
            findNavController().navigate(R.id.No_damage_From_Fragment_to_DetailTypeFragment, bundleOf("id" to typeId))
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabHome.setOnClickListener{
            findNavController().navigate(R.id.action_NoDamageFromFragment_to_first_fragment)
        }
            ...
            { state ->
                ...
                when(state) {
                    ...
                    is DetailTypeScreenState.Success -> {
                        binding.recyclerViewType.adapter = NoDamageFromAdapter(state.data.damage_relations.no_damage_from, typeListenner)
                    }
                }
