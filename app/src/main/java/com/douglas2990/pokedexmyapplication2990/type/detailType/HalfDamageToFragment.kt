...
import com.douglas2990.pokedexmyapplication2990.adapter.HalfDamageToAdapter
import com.douglas2990.pokedexmyapplication2990.databinding.FragmentTypeBinding

class HalfDamageToFragment : Fragment(){
    ...
    private val typeListenner = object : HalfDamageToAdapter.HalfDamageToInterface{
        override fun onClick(typeId: String) {
            findNavController().navigate(R.id.half_damage_To_Fragment_to_DetailTypeFragment, bundleOf("id" to typeId))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.fabHome.setOnClickListener{
            findNavController().navigate(R.id.action_half_damage_toFragment_to_first_fragment)
        }
            ...
            { state ->
                ...
                when(state) {
                    ...
                    is DetailTypeScreenState.Success -> {
                        binding.recyclerViewType.adapter = HalfDamageToAdapter(state.data.damage_relations.half_damage_to, typeListenner)
                    }
                }
            })
    }
