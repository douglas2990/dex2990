...
class SearchPokemonAdapter(private val list: List<Result>,
                           private var listenner: PokemonSearchInterface? = null
)
    : RecyclerView.Adapter<SearchPokemonAdapter.PokemonViewHolder>(){
    ...
    override fun onCreateViewHolder(
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.search_pokemon_adapter, parent, false)
    ...
    interface PokemonSearchInterface {
