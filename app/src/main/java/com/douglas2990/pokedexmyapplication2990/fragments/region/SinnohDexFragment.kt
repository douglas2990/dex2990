...
import com.douglas2990.pokedexmyapplication2990.viewModel.filtroRegions.PokemonSinnohViewModel

class SinnohDexFragment: Fragment() {
    private var _binding: FragmentFirstBinding? = null
    private val viewModel: PokemonSinnohViewModel by viewModels()
    ...
    private val firstListener = object : PokemonAdapter.PokemonInterface{
        override fun onClick(pokemonId: String){
            findNavController().navigate(R.id.action_SinnohFragment_to_SecondFragment, bundleOf("id" to pokemonId))
        }
    }
