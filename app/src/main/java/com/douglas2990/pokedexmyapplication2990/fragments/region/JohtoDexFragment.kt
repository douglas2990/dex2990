...
import com.douglas2990.pokedexmyapplication2990.viewModel.filtroRegions.PokemonJohtoViewModel

class JohtoDexFragment: Fragment() {
    private var _binding: FragmentFirstBinding? = null
    private val viewModel: PokemonJohtoViewModel by viewModels()
    ...
    private val firstListener = object : PokemonAdapter.PokemonInterface{
        override fun onClick(pokemonId: String){
            findNavController().navigate(R.id.action_JohtoFragment_to_SecondFragment, bundleOf("id" to pokemonId))
        }
    }
