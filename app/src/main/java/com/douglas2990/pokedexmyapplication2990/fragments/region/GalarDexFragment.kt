...
import com.douglas2990.pokedexmyapplication2990.viewModel.filtroRegions.PokemonGalarViewModel

class GalarDexFragment: Fragment() {
    private var _binding: FragmentFirstBinding? = null
    private val viewModel: PokemonGalarViewModel by viewModels()
    ...
    private val firstListener = object : PokemonAdapter.PokemonInterface{
        override fun onClick(pokemonId: String){
            findNavController().navigate(R.id.action_GalarFragment_to_SecondFragment, bundleOf("id" to pokemonId))
        }
    }
