...
import com.douglas2990.pokedexmyapplication2990.viewModel.filtroRegions.PokemonKantoViewModel

class KantoDexFragment: Fragment() {

    private var _binding: FragmentFirstBinding? = null
    private val viewModel: PokemonKantoViewModel by viewModels()
    ...
    private val firstListener = object : PokemonAdapter.PokemonInterface{
        override fun onClick(pokemonId: String){
            findNavController().navigate(R.id.action_KantoFragment_to_SecondFragment, bundleOf("id" to pokemonId))
        }
    }
