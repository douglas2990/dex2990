...
import com.douglas2990.pokedexmyapplication2990.viewModel.filtroRegions.PokemonAlolaViewModel

class AlolaDexFragment: Fragment() {
    private var _binding: FragmentFirstBinding? = null
    private val viewModel: PokemonAlolaViewModel by viewModels()
    ...
    private val firstListener = object : PokemonAdapter.PokemonInterface{
        override fun onClick(pokemonId: String){
            findNavController().navigate(R.id.action_AlolaFragment_to_SecondFragment, bundleOf("id" to pokemonId))
        }
    }
                            ...
                            is FirstScreenState.Success -> {
                                ...
                                searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener,
                                    ...
                                    override fun onQueryTextChange(newText: String?): Boolean {
                                        ...
                                        //searchPokemonAdapter2.filter.filter(newText)
                                        //binding.recyclerFirst.adapter = searchPokemonAdapter2
                                        binding.recyclerFirst.adapter = PokemonAdapter(listaPokemonBusca, firstListener)
