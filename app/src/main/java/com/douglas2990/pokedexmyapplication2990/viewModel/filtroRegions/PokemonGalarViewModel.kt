...
class PokemonGalarViewModel: ViewModel() {
    ...
    init {
        ...
        //RestManager.getEndpoints().getPokemon(899 - 810,809).enqueue(object :Callback<Model>{
        RestManager.getEndpoints().getPokemon(899 - 810,809).enqueue(object :Callback<PokemonList>{
