...
class PokemonKantoViewModel: ViewModel() {
    ...
    init {
        ...
        //RestManager.getEndpoints().getPokemon(151,0).enqueue(object : Callback<Model>{
        RestManager.getEndpoints().getPokemon(151,0).enqueue(object : Callback<PokemonList>{
