...
class PokemonHoennViewModel: ViewModel() {
    ...
    init {
        ...
        //RestManager.getEndpoints().getPokemon(135,251).enqueue(object : Callback<Model>{
        RestManager.getEndpoints().getPokemon(135,251).enqueue(object : Callback<PokemonList>{
