...
class PokemonAlolaViewModel: ViewModel() {
    ...
    init {
        ...
        //RestManager.getEndpoints().getPokemon(809-721, 721).enqueue(object : Callback<Model> {
        RestManager.getEndpoints().getPokemon(809-721, 721).enqueue(object : Callback<PokemonList> {
            override fun onResponse(
               ...
               } ?: run{state.value = FirstScreenState.Error(R.string.app_name)}
            }
